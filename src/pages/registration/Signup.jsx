...
function Signup() {
    ...
    return (
        <div className='flex justify-center mr-20 items-center h-screen'>
            {loading && <Loader/>}
            
            <div className='mr-1 '>
                <img src={signupImage} width="80%" alt="logo" />
            </div>
            ...
            <div className='bg-gray-800 px-10 py-10 rounded-xl'>
                ...
                <div className='flex justify-center mb-3'>
                    <button
                        onClick={signup}
                        className='bg-green-600 w-full text-white font-bold px-2 py-2 rounded-lg'>
                        Signup
                    </button>
                </div>
                <div>
