  ...
  return (
    <div className='bg-white sticky top-0 z-50'>
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-gray-400 px-4 text-sm font-medium text-white sm:px-6 lg:px-8" 
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6 nav_bar_a">
                 ...
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  {user?.user?.email === 'anubhavsrajput45@gmail.com' ? 
